...
uses UTF-8 text, reflects work completed through Phase 3, and incorporates the
Phase 3.5 amendment and the revised Phases 4–7.
...
## Phase 4 — Professional sketching, standards, and inspection
...
through rebuild/save/load, and inspection results agree with exact model data.

## Phase 5 — Imported-part editing and mesh intake

Phase 5 makes external parts useful rather than merely viewable.
...
- Use Euler/topology operators, pcurve rebuilding, healing, strict validation,
  and topology history so direct edits participate in naming and downstream
