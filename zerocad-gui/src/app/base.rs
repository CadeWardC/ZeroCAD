...
impl ZeroCadApp {
    ...
    pub(crate) fn new_with_settings(prefs: settings::AppSettings) -> Self {
        ...
        Self {
            ...
            pending_extrude_visibility: None,
            document,
            assembly_document: AssemblyDocument::new(),
            assembly_definition_geometry: BTreeMap::new(),
            assembly_scene_entities: HashMap::new(),
            assembly_unresolved_definitions: BTreeMap::new(),
            selected_assembly_occurrence: None,
            assembly_transform_edit_active: false,
            assembly_interactive_target: None,
            assembly_gizmo_mode: AssemblyGizmoMode::Translate,
            assembly_gizmo_local_space: false,
            assembly_gizmo_drag: None,
            assembly_rename_occurrence: None,
            selected_assembly_mate: None,
            assembly_mate_statuses: BTreeMap::new(),
            selected_node_id: None,
            text_dialog: None,
            sketch_regions_fingerprint: None,
            sketch_region_fill_cache: Vec::new(),
            sketch_region_ink_mask: Vec::new(),
            finished_sketch_regions: Default::default(),
            sketch_regions_dirty: false,
            last_region_recompute: None,
            ...
            hovered_body_element: None,
            hovered_sketch_element: None,
            hovered_active_sketch_element: None,
            hovered_active_sketch_region: None,
